@echo off
REM ===========================================================================
REM  System Admin Report — single-step generate & mail.
REM  Consolidates what used to be two separate scripts (run.bat + runmailing.bat)
REM  into one: captures a live Prometheus snapshot ONCE, builds the XLSX report
REM  from that same snapshot, and e-mails the styled preview to the mailing list
REM  with the report attached AND a link to the RBZ Monitoring Console webapp.
...
REM  palette. All output is written to run_and_mail_last.log so scheduled
REM  (no-console) runs can be diagnosed.
REM ===========================================================================
